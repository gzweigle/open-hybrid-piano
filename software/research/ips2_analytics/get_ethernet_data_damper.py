...
# This computer's IP address. Must match value in Damper Board Teensy.
UDP_IP = # FILL IN
# Port number must match value in Damper Board Teensy.
UDP_PORT = # FILL IN

client = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
client.bind((UDP_IP, UDP_PORT))
print("Client socket is setup - for damper")
file = open('ethernet_data_damper.txt', 'w')

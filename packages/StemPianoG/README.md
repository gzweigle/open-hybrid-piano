...
* Works with a digital keyboard (digital key sensors not included with the Model G).
...
Main code for the Teensy 4.1 processor on the IPS hardware connected to hammer sensors.
...
The only music output of Stem Pian G is MIDI. Connect a 5-pin DIN to the MIDI output port on the IPS 2.X board.
